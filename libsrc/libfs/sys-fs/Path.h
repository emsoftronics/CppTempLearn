    ...
    namespace Fs
    {
        ...
        */
        ...
        public:
            ...
            */
            Path &operator=(const Path &fsPath);
            ...
            */
            const std::string &unifiedPath() const;
            ...
            *    File path
            */
            virtual void setPath(std::string &&newPath);
            ...
            *
            *  @remarks
            *    If you want trailing separators to remain in the string, use unifiedPath().
            ...
            *
            *  @param[in] pathWRTThis
            *    Path wth respect to this object path
            *
            *  @return
            *    Combined path
            *
            ...
            */
            Path resolve(const Path &pathWRTThis) const;
        ...
        protected:
            ...
            mutable bool m_exists;               ///< Status of existance of file in filesystem
        };
