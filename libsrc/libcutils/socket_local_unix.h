...
#define UNIX_RESERVED_SOCKET_PREFIX "/dev/socket/"

/*
 * Set up a given sockaddr_un, to have it refer to the given
 * name in the given namespace. The namespace must be one
 * of <code>UNIX_SOCKET_NAMESPACE_ABSTRACT</code>,
 * <code>UNIX_SOCKET_NAMESPACE_RESERVED</code>, or
 * <code>UNIX_SOCKET_NAMESPACE_FILESYSTEM</code>. Upon success,
