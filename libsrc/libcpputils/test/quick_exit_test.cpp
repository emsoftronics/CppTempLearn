...
#include "cpputils-base/quick_exit.h"
...
TEST(quick_exit, smoke) {
  ASSERT_EXIT(cpputils::base::quick_exit(123), testing::ExitedWithCode(123), "");
}
...
TEST(quick_exit, at_quick_exit) {
  ...
  ASSERT_EQ(0, cpputils::base::at_quick_exit([]() { _exit(counter); }));
  ASSERT_EQ(0, cpputils::base::at_quick_exit([]() { counter += 2; }));
  ASSERT_EQ(0, cpputils::base::at_quick_exit([]() { counter *= 10; }));
  ASSERT_EXIT(cpputils::base::quick_exit(123), testing::ExitedWithCode(42), "");
}
