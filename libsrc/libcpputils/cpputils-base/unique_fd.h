...
// cpputils-base/macros.h, which causes macro collisions.
...
template <typename T>
int close(const cpputils::base::unique_fd_impl<T>&)
    __attribute__((__unavailable__("close called on unique_fd")));

template <typename T>
FILE* fdopen(const cpputils::base::unique_fd_impl<T>&, const char* mode)
    __attribute__((__unavailable__("fdopen takes ownership of the fd passed in; either dup the "
                                   "unique_fd, or use cpputils::base::Fdopen to pass ownership")));

template <typename T>
DIR* fdopendir(const cpputils::base::unique_fd_impl<T>&) __attribute__((
    __unavailable__("fdopendir takes ownership of the fd passed in; either dup the "
                    "unique_fd, or use cpputils::base::Fdopendir to pass ownership")));
